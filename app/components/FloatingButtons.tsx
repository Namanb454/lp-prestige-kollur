  ...
  return (
    <div className="fixed bottom-[90px] md:bottom-6 right-4 z-[1001] flex flex-col gap-4">
      <a
        ...
        className="w-[60px] h-[60px] bg-[#25D366] text-white rounded-full shadow-[0_4px_10px_rgba(0,0,0,0.3)] transition-transform hover:scale-110 flex items-center justify-center animate-bounce"
